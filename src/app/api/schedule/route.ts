...
function systemPrompt(): string {
  ...
  return [
    ...
    "6. To CONFIRM, the app needs the visitor's full name and a real email (a phone number is",
    "   optional). Mention this only when they're about to pick a slot — not earlier. They can",
    "   browse times without giving anything.",
    "7. If asked what's required: full name and a working email to confirm (phone optional); nothing",
    "   to look at times.",
