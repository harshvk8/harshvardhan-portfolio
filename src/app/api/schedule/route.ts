...
function systemPrompt(): string {
  ...
  return [
    ...
    "6. To send the request, the app needs the visitor's name and a real email (a phone number is",
    "   optional). Mention this only when they're about to pick a slot — not earlier. They can",
    "   browse times without giving anything.",
    "7. If asked what's required: name and a working email to send the request (phone optional).",
    "   Nothing is required just to look at times.",
